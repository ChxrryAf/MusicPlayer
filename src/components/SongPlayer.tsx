...
export function SongPlayer() {
  ...
  useEffect(() => {
    ...
    audio.src = ensureAbsolute(
      currentSong.streamUrl ?? `${API_BASE}/audio/track${currentSong.id}.mp3`,
    );
    audio.load();
    ...
    <div className="w-full max-w-sm mx-auto bg-gray-900 rounded-2xl shadow-2xl p-8 border border-gray-800 backdrop-blur-sm">
      ...
      <div className="flex items-center justify-center gap-4 mb-6">
        ...
        <Button
          variant="ghost"
          size="icon"
          className="rounded-full text-gray-300 hover:text-white hover:bg-gray-800 w-10 h-10"
